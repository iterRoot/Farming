...
public class JournalEntry : AuditableEntity
{
    ...
    public string? BaseDocType { get; set; }                  // Source document type (KARI, KPAI, etc.)
    ...
    public string? Memo { get; set; }                         // Description
...
public class JournalEntryLine : AuditableEntity
{
    ...
    public string AccountCode { get; set; } = null!;        // Chart of Account
    public string AccountName { get; set; } = null!;                  // For display
    public string CardCode { get; set; } = null!;                     // Business Partner Code
    public string CardName { get; set; } = null!;                     // Business Partner Name
