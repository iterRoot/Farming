...
public class APReserveInvoicePdfDocument : IDocument
{
    private readonly APReserveInvoice _invoice;
    private readonly CompanyEntity?   _company;

    public APReserveInvoicePdfDocument(APReserveInvoice invoice, CompanyEntity? company)
    {
        _invoice = invoice;
        _company = company;
    }
    ...
    private void ComposeHeader(IContainer container)
    {
        container.Row(row =>
        {
            ...
            {
                col.Item().AlignRight().Text("AP RESERVE INVOICE")
