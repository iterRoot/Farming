...
public class ARReserveInvoicePdfDocument : IDocument
{
    private readonly ARReserveInvoice _invoice;
    private readonly CompanyEntity?   _company;

    public ARReserveInvoicePdfDocument(ARReserveInvoice invoice, CompanyEntity? company)
    {
        _invoice = invoice;
        _company = company;
    }
    ...
    private void ComposeHeader(IContainer container)
    {
        container.Row(row =>
        {
            ...
            {
                col.Item().AlignRight().Text("AR RESERVE INVOICE")
