...
namespace FarmingApi.Modules.MilkBacth;

public class MilkBacth : AuditableEntity
{
...
public class BreedingConfig : IEntityTypeConfiguration<MilkBacth>
{
	public void Configure(EntityTypeBuilder<MilkBacth> builder)
	{
