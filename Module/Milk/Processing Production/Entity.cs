...
public class ProcessingProduction : AuditableEntity
{
...
public class BreedingConfig : IEntityTypeConfiguration<ProcessingProduction>
{
	public void Configure(EntityTypeBuilder<ProcessingProduction> builder)
	{
		...
		// 	.WithOne(o => o.ProcessingProduction)
