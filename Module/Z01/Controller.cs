...

{
	...
	public IActionResult Gets()
	{
		...
		var results = _mapper.ProjectTo<TestListResponse>(iQueryable).ToList();
	...
	public IActionResult Get(int id)
	{
		...
		var result = _mapper.Map<TestListResponse>(item);
		return Ok(result);
	}

    [HttpPost]
    public IActionResult Create([FromBody] TestListRequest request)
    {
...
// tubecoffee@kpt
	...
	// [HttpPost]
	// public IActionResult CreatTest([FromForm] TestListRequest request)
	// {
	// 	if (!ModelState.IsValid)
	// 		return BadRequest(ModelState);
	// 	var cow = _mapper.Map<Test>(request);
	// 	cow.CreatedAt = DateTime.UtcNow;
	// 	cow.InActive = false;
	// 	_repository.Add(cow);
	// 	_repository.Commit();
	// 	var response = _mapper.Map<TestListResponse>(cow);
	// 	return CreatedAtAction(nameof(Gets), new { id = response.Id}, response);
	// }
// 	[HttpPost]
// public IActionResult CreatTest([FromBody] TestListRequest request)
// {
//     if (!ModelState.IsValid) return BadRequest(ModelState);
...
// }
	...
	// [HttpPut("{id:int}")]
	[HttpPut("{id}")]
	public IActionResult Update(int id, [FromForm] TestUpdateRequest request)
	{
		var item = _repository.GetSingle(e => e.Id == id);
